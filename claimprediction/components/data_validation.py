...
from claimprediction.entity.config_entity import DataValidationConfig
from claimprediction.constant.training_pipeline import SCHEMA_FILE_PATH
from claimprediction.entity.artifact_entity import DataIngestionArtifact,DataValidationArtifact
from scipy.stats import ks_2samp
import pandas as pd
import os,sys
from claimprediction.utils.main_utils.utils import read_yaml_file,write_yaml_file
...
class DataValidation:
    ...
    def validate_no_of_columns(self,dataframe:pd.DataFrame) -> bool:
        try:
            ...
            if len(dataframe.columns) == len(self._schema_config):
                return True
            else:
                return False
        except Exception as e:
