...
import os
from claimprediction.constant import training_pipeline
...
class FeatureSelectionConfig:
     def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        self.feature_selection_dir: str = os.path.join(training_pipeline_config.artifact_dir,training_pipeline.FEATURE_SELECTION_DIR_NAME )
        self.feature_selected_train_file_path: str = os.path.join( self.feature_selection_dir,training_pipeline.FEATURE_SELECTION_DATA_DIR,
            training_pipeline.TRAIN_FILE_NAME.replace("csv", "npy"),)
